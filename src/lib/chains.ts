...
export const WPLS_ADDRESS = '0xA1077a294dDE1B09bB078844df40758a5D0f9a27' as `0x${string}`;
export const USDC_ADDRESS = '0x15D38573d2feeb82e7ad5187aB8c1D52810B1f07' as `0x${string}`;
