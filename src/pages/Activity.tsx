...
import { Loader2, Lock, TrendingUp, Flame, Coins, RefreshCw } from 'lucide-react';
...
export default function Activity() {
          ...
          <div className="container mx-auto px-4 py-16">
            <Card className="max-w-md mx-auto">
              <CardHeader>
                ...
                <CardDescription>
                  Please connect your wallet to access the Activity page
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
  ...
  if (isCheckingOwner || isLoadingMetrics) {
    return (
      <>
        <Navbar />
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Update activity metrics manually (Admin only)
              </p>
            </div>
                  ...
                  <Card key={metric.id}>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor={metric.metric_name}>New Value</Label>
            ...
            <Card className="bg-primary/5 border-primary/20">
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                <p>• Only contract owners can update these metrics</p>
                <p>• Values are displayed publicly on the frontend</p>
